	...
	<div class="parent">
		<header class="header">
			<div class="container">
				<section class="logo">
					<a href="index.php"> 
						<img src="images/rochester.png" alt="rochester">
					</a>
				</section>
		...
		<footer class="footer"> <strong> CSC 174: Advanced Front-end Web Design and Development </strong></footer>
=======
	<header>
		<a href= "index.php">
			<h1> Odd Student Out </h1>	
...
>>>>>>> c7f0aa94088d1535ab8f8f941c6f50ccc8df94fd
